...
namespace RealTimeLidar {
    class Controls {
        ...
        void handleKeyState(PacketReceiver& receiver, Camera& camera, bool& brakes);
    public:
        bool init();
        int update(PacketReceiver& receiver, Camera& camera, GridDrawer<CartesianPoint>& gridDrawer, bool& brakes);
    };
}
